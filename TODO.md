...
- [ ] Custom session templates - have some sort of '.luminos_rc' file that can be read in the current dir, and upon launcing luminos, have it prompt if you'd like to utilize the luminos_rc prompt, which would help guide the LLM for the particular project, such as instructions for familiarizing yourself.
